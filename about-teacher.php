                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <ul class="breadcrumb float-right p-0 mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="all-teachers.html">Teachers</a></li>
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="aboutme-profile">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <p>Hello I am Michael V. Buttars .Lorem Ipsum is simply dummy text
                                                        of the printing and typesetting industry. Lorem Ipsum has been
                                                        the</p>
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item"><b>ID</b><a href="#"
                                                                class="float-right">FD-00d1</a></li>
                                                        <li class="list-group-item"><b>Gender</b><a href="#"
                                                                class="float-right">Male</a></li>
                                                        <li class="list-group-item"><b>Seminors Done</b><a href="#"
                                                                class="float-right">30+</a></li>
                                                        <li class="list-group-item"><b>Degree</b><a href="#"
                                                                class="float-right">P.H.D</a></li>
                                                        <li class="list-group-item"><b>Desgination</b><a href="#"
                                                                class="float-right">Maths Teacher</a></li>
                                                        <li class="list-group-item"><b>Joining Date</b><a href="#"
                                                                class="float-right">16/09/2018</a></li>
                                                    </ul>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3 col-6"> <strong>Email</strong>
                                                                        <p class="text-muted"><a
                                                                                ...
                                                                                class="__cf_email__"
                                                                                data-cfemail="82efebe1eae3e7eef4e0f7f6f6e3f0f1c2e7fae3eff2eee7ace1edef">[email&#160;protected]</a>
                                                                        </p>
                                                                    </div>
