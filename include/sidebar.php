        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <div class="header-left">
                <a href="index.php" class="logo">
                    <img src="assets/img/logo-eric-bar.png" width="230" alt="">
                    <!-- <span class="text-uppercase">eric cambodia</span> -->
                </a>
            </div>
            <ul class="sidebar-ul">
                ...
                <li>
                    <a href="calendar.php"><img src="assets/img/sidebar/icon-6.png" alt="icon">
                        <span>Calendar</span></a>
                </li>
                <li>
                    <a href="exam-list.php"><img src="assets/img/sidebar/icon-7.png" alt="icon"> <span>Exam
                            list</span></a>
                </li>
                <li>
                    <a href="holidays.php"><img src="assets/img/sidebar/icon-8.png" alt="icon">
                        <span>Holidays</span></a>
                </li>
                <li>
                    <a href="calendar.php"><img src="assets/img/sidebar/icon-9.png" alt="icon"><span>
                            Events</span></a>
                </li>
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                ...
                                <li><a href="leaves.php"><span>Leave Requests</span> <span
                ...
                <li>
                    <a href="settings.php"><img src="assets/img/sidebar/icon-14.png" alt="icon">
